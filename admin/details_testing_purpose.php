                        ...
                        <div class="card">
                            <?php if ($row3 != null) { ?>
                                <div class="table-responsive">
                                    <form action="testing_purpose.php" method="post">
                                            ...
                                            <tr>
                                                <td>
                                                    <form action="delete.php" method="post">
                                                        <a href="edit_testing_purpose.php?ID=<?php echo $row3['id']; ?>">
                                                            <i class="fa fa-edit">Edit &nbsp;</i>
                                                        </a>
                                                        <button style="background-color: white; border-color: white; color:red;" type="submit" class="fa fa-trash" name="deletepurpose">
                                                            Delete
                                                        </button>
