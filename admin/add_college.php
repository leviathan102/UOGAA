                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Add College/Program</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card" style="align-items: center; background-color:cyan; padding:8px">
                            ...
                            <?php if (isset($_POST['submit'])) {
                                $fname = $_POST['name'];
                                $sql = "INSERT INTO `college_list`(`name`) VALUES ('$fname')";
                            ...
                            ?>
                                ...
                                <a href="college.php" style="background-color: blue; color:white; border-radius:4px; padding:4px">
                                    OK
                                </a> <br>
                            <?php } ?>
                            <div class="container">
                                <header>
                                    Add College/Program/Unit Form
                                </header>
