                        ...
                        <div class="card">
                            <?php if ($row3 != null) { ?>
                                <div class="table-responsive">
                                    <form action="referral_reason.php" method="post">
                                            ...
                                            <tr>
                                                <td>
                                                    <form action="delete.php" method="post">
                                                        <a href="edit_reason_for_referral.php?ID=<?php echo $row3['id']; ?>">
                                                            <i class="fa fa-edit">Edit &nbsp;</i>
                                                        </a>
                                                        <button style="background-color: white; border-color: white; color:red;" type="submit" class="fa fa-trash" name="deletereason">
                                                            Delete
                                                        </button>
