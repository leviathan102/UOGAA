                        ...
                        <div class="col-12">
                            <div class="card" style="align-items: center; background-color:cyan; padding:8px">
                                ...
                                <?php if (isset($_POST['submit'])) {
                                    ...
                                    $sql = "INSERT INTO `counselor_user`
                                (`username`,`email`, `password`, `access`, `college`, `status`) 
                                VALUES ('$fname','$femail', '$fpassword', '$faccess','$college', '$fstatus')";
                                ...
                                ?>
                                    ...
                                    <a href="user_accounts.php" style="background-color: blue; color:white; border-radius:4px; padding:4px">
                                        OK
                                    </a> <br>
                                <?php } ?>
                                <div class="container">
                                        ...
                                        <div class="form first">
                                            <div class="details personal">
                                                ...
                                                <div class="fields">
                                                    ...
                                                    <div class="input-field">
                                                        <label>College/Program/Unit/Association/Guidance</label>
                                                        <select name="college_of" type="text" required>
                                                            <option value=""></option>
                                                            <?php
                                                            do {
                                                                if ($row != null) {
                                                            ...
                                                            <?php if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator") { ?>
                                                            <option style="color:blue">Guidance Office</option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
