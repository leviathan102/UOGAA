...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $sql3 = "SELECT * FROM testing_service WHERE id = '$id'";
                        ...
                        <div class="col-5">
                            ...
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="college_testing.php"> Home</a></li>
                                        <li class="breadcrumb-item"><a href="#"> Testing Details</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <table id="example" class="table table-hover">
                                        <?php if ($row3 != null) { ?>
                                            <thead style=" white-space: nowrap; ">
                                                <tr>
                                                    <th>
                                                        <form action="college_testing.php" method="post">
                                                            <input type="hidden" name="testingname" value="<?php echo $row3['college_of'] ?>">
                                                            <button type="submit" name="collegetesting" style="border: none;">
                                                ...
                                                <tr>
                                                    <?php if ($row3['name'] != null) { ?>
                                                        <th>Name</th>
                                                        <td><?php echo $row3['name']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                    <?php if ($row3['email'] != null) { ?>
                                                        <th>Email</th>
                                                        <td style="color: blue;"><?php echo $row3['email']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                    <?php if ($row3['age'] != null) { ?>
                                                        <th>Age</th>
                                                        <td><?php echo $row3['age']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                    <?php if ($row3['college_of'] != null) { ?>
                                                        <th>College/Program/Unit</th>
                                                        <td><?php echo $row3['college_of']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <?php if ($row3['purpose'] != null) { ?>
                                                        <th>Purpose</th>
                                                        <td><?php echo $row3['purpose']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                    <?php if ($row3['option_for_newly_hired'] != null) { ?>
                                                        <th>For Newly Hired</th>
                                                        <td><?php echo $row3['option_for_newly_hired']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                    <?php if ($row3['date_prefer'] != null) { ?>
                                                        <th>Prefer Date</th>
                                                        <td><?php echo $row3['date_prefer']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                    <?php if ($row3['time_prefer'] != null) { ?>
                                                        <th>Prefer Time</th>
                                                        <td><?php echo $row3['time_prefer']; ?></td>
                                                    <?php } ?>
                                                </tr>
                                                <tr>
                                                    <th>Assisted</th>
                                                    ...
                                                    if (isset($_POST['cateredby'])) {
                                                        ...
                                                        $catered = $_POST['name'];
                                                        $sql2 = "UPDATE `testing_service` SET `catered_by`='$catered' WHERE id = '$id'";
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($row3['catered_by'] == null || $row3['catered_by'] == 'notset') {
                                                            $sql4 = "SELECT * FROM `counselor_user` WHERE access='Counselor' ORDER by username ASC";
                                                            $counselor = $con->query($sql4) or die($con->error);
                                                            $row4 = $counselor->fetch_assoc();
                                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        if ($_POST['status'] == "Reject") {
                                                            ...
                                                            $mail->addAddress($mailTo, "GuidanceOffice");
                                                            $mail->isHTML(true);
                                                            $mail->Subject = "Testing Request Rejected";
                                                            $mail->Body = $body;
                                                            $mail->AltBody = "text version";
                                                    ...
                                                    <td>
                                                        <form action="" method="post">
                                                            <?php
                                                            if ($row3['status'] != "Done" && $row3['catered_by'] != 'notset') { ?>
                                                                <ul>
                                                                    <li>
                                                                        <select name="status" id="status" value="<?php echo $row['status']; ?>" required>
                                                                            <option disabled selected>---Select---</option>
                                                                            <option value="Approved" <?php echo ($row3['status'] == "Approved") ? 'selected' : ''; ?>>Approved</option>
                                                                            <option value="Reject" <?php echo ($row3['status'] == "Reject") ? 'selected' : ''; ?>>Unattended</option>
                                                                            <option value="Done" <?php echo ($row3['status'] == "Done") ? 'selected' : ''; ?>>Done</option>
                                                                        </select>
                                                                        <?php if ($row3['status'] == "Approved") { ?>
                                                                            <input type="hidden" name="message" value="<?php echo $row3['room']; ?>">
                                                                            </textarea>
                                                                        <?php } else if ($row3['status']==null || $row3['status']=='deanrequest') { ?>
                                                                    ...
                                                                    <li>
                                                                        <input type="hidden" name="name" required id="" value="<?php echo $row3['name']; ?>" />
                                                                        <input type="hidden" required name="email" id="" value="<?php echo $row3['email']; ?>" />
                                                                        <input type="hidden" required name="date" id="" value="<?php echo $row3['date_prefer']; ?>" />
                                                                        <input type="hidden" required name="time" id="" value="<?php echo $row3['time_prefer']; ?>" />
                                                                        <input type="hidden" required name="catered" id="" value="<?php echo $row3['catered_by']; ?>" />
                                                                    </li>
                                                                </ul>
                                                            <?php } else if ($row3['status'] == "Approved") { ?>
                                                                <b style="color:green;"><?php echo $row3['status']; ?></b>
                                                                <i class="fa fa-check" style="color: green;">
                                                                <?php } else if ($row3['status'] == "Reject") { ?>
                                                                    <b style="color: red;"><?php echo $row3['status']; ?></b>
                                                                <?php } else if ($row3['status'] == "noaction") {
                                                                echo $row3['status']; ?>
                                                                <?php } else if ($row3['status'] == "Done") { ?>
                                                                    <b style="color:green;"><?php echo $row3['status']; ?></b>
                                                                    <i class="fa fa-check" style="color: white; background-color: green; border-radius: 8px;">
                                                                    <?php } else{ echo $row3['status']; } ?>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    if (isset($_POST['saveoutcome'])) {
                                                        ...
                                                        $outcome = $_POST['testout'];
                                                        $sql = "UPDATE `testing_service` SET `outcome`='$outcome' WHERE id = '$id'";
                                                        $con->query($sql) or die($con->error);
                                                    ?>
                                                        <meta http-equiv="refresh" content="1">
                                                        <p>
                                                ...
                                                <tr>
                                                    ...
                                                    if (isset($_POST['deletetestingrecord'])) {
                                                        $id = $_POST['ID'];
                                                    ...
                                                    <!--<th>
                                                        <form action="" method="post">
                                                         <button class="btn btn-primary btn-block" style="color: white; border-color: white;" type="submit" name="deletetestingrecord">
