                                            ...
                                            <tr>
                                                <td>
                                                    <form action="delete.php" method="post">
                                                        <a href="edit_course.php?ID=<?php echo $row3['id']; ?>">
                                                            <i class="fa fa-edit">Edit &nbsp;</i>
                                                        </a>
                                                        <button style="background-color: white; border-color: white; color:red;" type="submit" class="fa fa-trash" name="deletecourse">
                                                            Delete
                                                        </button>
