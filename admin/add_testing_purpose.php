...
$sql2 = "SELECT * FROM testing_purpose_list ORDER BY name ASC";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title"><i class="fas fa-puzzle-piece"></i> Purpose for Testing</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="testing_purpose.php"> Home</a></li>
                                    <li class="breadcrumb-item"><a href="#"> Add Purpose</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card" style="align-items: center; background-color:cyan; padding:8px">
                            ...
                            <?php if (isset($_POST['submit'])) {
                                $fname = $_POST['name'];
                                $sql = "INSERT INTO `testing_purpose_list`(`name`) VALUES ('$fname')";
                            ...
                            ?>
                                ...
                                <a href="testing_purpose.php" style="background-color: blue; color:white; border-radius:4px; padding:4px">
                                    OK
                                </a> <br>
                            <?php } ?>
                            <div class="container">
                                <header>
                                    Add Testing Purpose Name Form
                                </header>
                                    ...
                                    <div class="form first">
                                        <div class="details personal">
                                            ...
                                            <div class="input-field">
                                                <label>Testing Purpose Name</label> <br>
                                                <textarea name="name" cols="30" rows="3" required></textarea>
                                            </div>
                                        </div>

                                        <div class="details ID">
                                            <button id="nxtBtn" role="button" type="submit" name="submit" value="Submit Form" class="btn btn-success btn-block">
                                                <span class="btnText"> Insert</span>
