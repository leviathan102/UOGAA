...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $start = ($page - 1) * $limit;
    $sql = "SELECT * FROM counseling_appointment WHERE college_of='$collegefilter' ORDER BY id DESC LIMIT $start, $limit";
    $appointment = $con->query($sql) or die($con->error);
    $row = $appointment->fetch_assoc();

    $sql01 = "SELECT count(id) AS id FROM counseling_appointment WHERE college_of='$collegefilter'";
                            ...
                            <div class="card">
                                <div class="table-responsive" style="padding: 8px; ">
                                    ...
                                    <div class="container" style="padding-bottom: 8px; background-color:aquamarine">
                                        <form action="counseling_limit.php" method="post" id="form" name="form">
                                            <ul class="pagination pagination" style="margin-left: 20% ;">
                                                <a href="counselling.php?page=<?php echo $previous; ?>" style="padding:8px;">
                                                    &laquo; Previous
                                                </a>
                                                <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                                    <li style="padding:8px; ">
                                                        <a href="counselling.php?page=<?php echo $i; ?>">
                                                            <?php echo $i; ?>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                                <a href="counselling.php?page=<?php echo $next; ?>" style="padding:8px;">
                                                    Next &raquo;
                                                </a>
                                            </ul>
                                        </form>
                                    </div>
                                    <form action="counseling_search_result.php" method="get" style="padding:8px;">
                                        <input type="text" required placeholder="Input Name" name="counselsearch">
                                        <button type="submit" class="btn btn-primary btn-block" name="counselingsearch">Search</button>
                                    </form>
                                        ...
                                        <?php if ($row != null) { ?>
                                            ...
                                            <?php do { ?>
                                                ...
                                                ?>
                                                    <tbody>
                                                        <tr>
                                                            <td style=" white-space: nowrap; ">
                                                                <b>
                                                                    <a href="details_counseling.php?ID=<?php echo $row['id']; ?>">Details</a>
                                                                </b>
                                                            </td>
                                                            <td style=" white-space: nowrap; ">
                                                                <?php
                                                    ...
                                                    <?php } else {
                                                    echo '<h4 style="color: red;" >' . '<b>' . 'Counseling' . '<b>' . ' (No Data!)' . '</h4>';
                                                } ?>
