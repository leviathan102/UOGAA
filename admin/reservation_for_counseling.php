                        ...
                        <div class="card" style="padding:8px;">
                            <div class="table-responsive">
                                <table id="example" class="table table-hover">
                                    <h3> Counseling Reservation</h3>

                                    <div class="form-floating mb-3" style="padding: 8px; background-color: skyblue;">
                                        <form action="add_counseling_date.php" method="post">
                                            ...
                                            <button role="button" name="addcounseling" class="btn btn-primary btn-block">
                                                Add Date & Time
                                            </button>
                                                ...
                                                <?php if ($row5 != null) { ?>
                                                    <td>
                                                        <form action="" method="post">
                                                            <button class="fa fa-trash" style="color: red; border-color: white;" type="submit" name="deletedate">
                                                                Delete
                                                            </button>
                                                            <input type="hidden" name="ID" value="<?php echo $row5['id']; ?>">
                                                            <input type="hidden" name="date" value="<?php echo $row5['apointment_date']; ?>">
                                                        </form>
                                                    </td>
                                    ...
                                    <thead style=" white-space: nowrap; background-color: skyblue; ">
                                        <tr>
                                            <th>
                                                <form action="add_counseling_time.php" method="post">
                                                    <button role="button" name="addcounseling" class="btn btn-primary btn-block">
                                                        Add Time
                                                    </button>
                                                </form>
                                        ...
                                        <?php do { ?>
                                            <tr>
                                                <?php if ($row6 != null) { ?>
                                                    <td>
                                                        <form action="" method="post">
                                                            <button class="fa fa-trash" style="color: red; border-color: white;" type="submit" name="deletetime">
                                                                Delete
                                                            </button>
                                                            <input type="hidden" name="ID" value="<?php echo $row6['id']; ?>">
                                                            <input type="hidden" name="time" value="<?php echo $row6['apointment_time']; ?>">
                                                        </form>
                                                    </td>
