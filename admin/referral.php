...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $start = ($page - 1) * $limit;
    $sql = "SELECT * FROM referral_counseling WHERE college_of='$collegefilter' ORDER BY id DESC LIMIT $start, $limit";
                            ...
                            <div class="card">
                                <div class="table-responsive" style="padding: 8px; ">
                                    ...
                                    <form action="referral_search_result.php" method="get" style="padding:8px;">
                                        <input type="text" required placeholder="Input Name" name="refsearch">
