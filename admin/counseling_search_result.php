...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $search1 = $_GET['counselsearch'];
    $collegefilter = $_SESSION['College'];

    $limit = isset($_POST["limit-records"]) ? $_POST["limit-records"] : 30;
    $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
    $start = ($page - 1) * $limit;
    $sql = "SELECT * FROM counseling_appointment WHERE name LIKE '%$search1%' AND college_of='$collegefilter'
    ORDER BY id DESC";
    $appointment = $con->query($sql) or die($con->error);
    $row = $appointment->fetch_assoc();
    
    $query0 = "SELECT * FROM counseling_appointment WHERE name LIKE '%$search1%' AND college_of='$collegefilter'
    ORDER BY id DESC";;
                            ...
                            <div class="card">
                                <div class="table-responsive" style="padding: 8px; ">
                                    <form action="counseling_search_result.php" method="get" style="padding:8px;">
                                        <input type="text" required placeholder="Input Name" name="counselsearch" value="<?php if ($search1 != null) {
                                                                                                                                echo $search1;
                                                                                                                            } ?>">
                                        ...
                                        <?php if ($row != null) { ?>
                                            ...
                                            <?php do { ?>
                                                ...
                                                ?>
                                                    ...
                                                    <?php } else {
                                                    echo '<h4 style="color: red;" >' . '<b>' . 'Counseling' . '<b>' . ' (No result!)' . '</h4>';
                                                } ?>
