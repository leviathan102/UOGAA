...
$sql = "SELECT * FROM testing_purpose_list ORDER BY name ASC";
                                    ...
                                    <?php do { ?>
                                        <?php if ($row != null) { ?>
                                            <tbody style=" white-space: nowrap; ">
                                                <tr>
                                                    <td>
                                                        <a href="details_testing_purpose.php?ID=<?php echo $row['id']; ?>">
                                                            Details
                                                        </a>
                                                    </td>
                                        ...
                                        <?php } else {
                                            echo '<h4 style="color: red;" >' . '<b>' . 'Purpose for Testing' . '<b>' . ' (No Data!)' . '</h4>';
                                        } ?>
