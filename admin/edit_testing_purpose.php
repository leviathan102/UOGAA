...
$id = $_GET['ID'];
$sql3 = "SELECT * FROM testing_purpose_list WHERE id = '$id'";
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#"> Edit Purpose</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card" style="align-items: center; background-color:cyan; padding:8px">
                            ...
                            <?php if (isset($_POST['submit'])) {
                                ...
                                $sql = "UPDATE `testing_purpose_list` SET `name`='$funame' WHERE id = '$id'";
                                ...
                                <a href="details_testing_purpose.php?ID=<?php echo $row3['id']; ?>" style="background-color: blue; color:white; border-radius:4px; padding:4px">
                                    OK
                                </a> <br>
                            <?php } ?>
                            <div class="container">
                                <header>
                                    Update Testing Purpose Name Form
                                </header>
                                <?php if ($row3 != null) { ?>
