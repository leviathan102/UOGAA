...
if (isset($_POST['limit-records'])) {
    ...
    $start = ($page - 1) * $limit;
    $sql = "SELECT * FROM counseling_appointment ORDER BY id DESC LIMIT $start, $limit";
    $appointment = $con->query($sql) or die($con->error);
    $row = $appointment->fetch_assoc();

    $sql01 = "SELECT count(id) AS id FROM counseling_appointment";
...
// $limit = isset($_POST["limit-records"]);
// $page = isset($_GET['page']) ? $_GET['page'] : 1;
// $start = ($page - 1) * $limit;
// $sql = "SELECT * FROM counseling_appointment ORDER BY id DESC LIMIT $start, $limit";
// $appointment = $con->query($sql) or die($con->error);
                        ...
                        <div class="card">
                            <div class="table-responsive" style="padding: 8px;">
                                ...
                                <!-- <h2>
                                    Counseling (
                                    <?php
                                    $query0 = "SELECT * FROM counseling_appointment ORDER BY added_at DESC";
                                    $query_run0 = mysqli_query($con, $query0);
                                    $row0 = mysqli_num_rows($query_run0);

                                    ?>
                                    <b style="color: blue;"><?php echo  $row0; ?></b>
                                    )
                                </h2> -->
                                <!-- counseling table -->
                                <!-- <div class="container">
                                    <ul class="pagination pagination">
                                        <a href="counseling_limit.php?page=<?php echo $previous; ?>" style="padding:8px;">
                                            &laquo; Previous
                                        </a>
                                        <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                            <li style="padding:8px;">
                                                <a href="counseling_limit.php?page=<?php echo $i; ?>">
                                                    <?php echo $i; ?>
                                                </a>
                                            </li>
                                        <?php } ?>
                                        <a href="counseling_limit.php?page=<?php echo $next; ?>" style="padding:8px;">
                                            Next &raquo;
                                        </a>
                                    </ul>
                                </div> -->
                                <div class="container" style="padding-bottom: 8px; text-align:center; background-color:aquamarine">
                                    <form action="counseling_limit.php" method="post">
                                        <label style="font-weight: bolder; margin-top: 25px">
                                        ...
                                        <!-- <button role="button" type="submit" name="limit-button"> Submit</button> -->
                                    </form>
                                </div>
                                            ...
                                            <tbody style=" white-space: nowrap; ">
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                    echo $row['facebook_account'];
                                                                    ?>
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                    echo $row['prefered_time'];
                                                                    ?>
                                                                </td> -->
                                                    <td>
                                                        <?php
