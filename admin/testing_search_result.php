...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $sql3 = "SELECT * FROM testing_service WHERE name LIKE '%$search1%' 
    AND status!='noaction' AND college_of='$collegefilter' 
    ORDER BY id DESC";
                            ...
                            <div class="card">
                                <div class="table-responsive" style="padding-bottom: 8px; ">
                                    ...
                                    <form action="testing_search_result.php" method="get" style="padding:8px;">
                                        <input type="text" required placeholder="Input Name" name="tessearch" value="<?php if ($search1 != null) {
                                                                                                                            echo $search1;
                                                                                                                        } ?>">
                                    ...
                                    <table style="padding: 8px; ">
                                        ...
                                        <?php do { ?>
                                            <?php if ($row3 != null) { ?>
                                                ...
                                                <?php } else {
                                                echo '<h4 style="color: red;" >' . '<b>' . 'Testing' . '<b>' . ' (No result!)' . '</h4>';
                                            }
                                                ?>
                                ...
                                <div class="table-responsive" style="padding-bottom: 8px; ">
                                    ...
                                    <div class="container" style="padding-bottom: 8px;">
                                        <!-- <form action="" method="post">
                                            <?php
                                            $sql = "SELECT * FROM testing_service WHERE college_of='$college'
                                            AND status='deanrequest' ORDER BY id DESC";
                                            $testing3 = $con->query($sql) or die($con->error);
                                            $row5 = $testing3->fetch_assoc();
                                            ?>
                                            <div class="form-floating mb-3">
                                                <input type="date" name="reqdate" required value="<?php echo $row5['date_prefer'] ?>">
                                                <input type="time" name="reqtime" required value="<?php echo $row5['time_prefer'] ?>">
                                                <input type="hidden" required name="reqstat" value="Approved">
                                                <input type="hidden" required name="reqcollege" value="<?php if ($college != null) {
                                                                                                            echo $college;
                                                                                                        } ?>">
                                            </div>
                                            <div class="form-floating mb-3">
                                                <button role="button" name="approvetestingrequest" class="btn btn-primary btn-block">
                                                    Approve
                                                </button>
                                            </div>
                                        </form> -->
