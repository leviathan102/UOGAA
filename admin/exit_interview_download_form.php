...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $start = ($page - 1) * $limit;
    $sql = "SELECT * FROM exit_interview_download_form ORDER BY id DESC LIMIT $start, $limit";
    $appointment = $con->query($sql) or die($con->error);
    $row = $appointment->fetch_assoc();

    $sql01 = "SELECT count(id) AS id FROM exit_interview_download_form";
            ...
            <div class="page-wrapper">
                ...
                <div class="page-breadcrumb">
                    <div class="row align-items-center">
                        <div class="col-5">
                            <h4 class="page-title"><i class="mdi mdi-account-switch"></i> Exit Interview Download the Form</h4>
                                    ...
                                    <div class="container" style="padding-bottom: 8px; background-color:aquamarine">
                                        <form action="" method="post" id="form" name="form">
                                            <ul class="pagination pagination" style="margin-left: 20% ;">
                                                <a href="exit_interview_download_form.php?page=<?php echo $previous; ?>" style="padding:8px;">
                                                    &laquo; Previous
                                                </a>
                                                <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                                    <li style="padding:8px; ">
                                                        <a href="exit_interview_download_form.php?page=<?php echo $i; ?>">
                                                            <?php echo $i; ?>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                                <a href="exit_interview_download_form.php?page=<?php echo $next; ?>" style="padding:8px;">
                                                    Next &raquo;
                                                </a>
                                            </ul>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style=" white-space: nowrap; ">
                                                                <b>
                                                                    <a href="details_exit_interview_download.php?ID=<?php echo $row['id']; ?>">Details</a>
                                                                </b>
                                                            </td>
