...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $sql = "SELECT * FROM referral_counseling WHERE id = '$id'";
    $appointment = $con->query($sql) or die($con->error);
    $row = $appointment->fetch_assoc();
?>

    <head>
        <title>BukSU Guidance Office | Details Referral</title>
        <style>
            table {
            ...
            <div class="page-wrapper">
                ...
                <div class="page-breadcrumb">
                    <div class="row align-items-center">
                        <div class="col-5">
                            <h4 class="page-title"><i class="mdi mdi-account-switch"></i> Referral Counseling</h4>
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="referral.php"> Home</a></li>
                                        ...
                                        <table id="example" class="table table-hover">
                                            <?php if ($row != null) { ?>
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <?php if ($row['facebook_name'] != null) { ?>
                                                            <th>Facebook Name</th>
                                                            <td><?php echo $row['facebook_name']; ?></td>
                                                        <?php } ?>
                                                    </tr>
                                                    <tr>
                                                        <?php if ($row['preferred_time'] != null) { ?>
                                                            <th>Prefered Time</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if (isset($_POST['cateredby'])) {
                                                            $caterid = $_POST['ID'];
                                                            $catered = $_POST['catername'];
                                                            $sql2 = "UPDATE `referral_counseling` SET `catered_by`='$catered' WHERE id = '$caterid'";
                                                    ...
                                                    <tr>
                                                        ...
                                                        if (isset($_POST['sendEmail'])) {
                                                            $status = $_POST['status'];
                                                            $sql = "UPDATE `referral_counseling` 
                                                            ...
                                                            if ($_POST['status'] == "Approved") {
                                                                ...
                                                                $cater = $_POST['catered'];
                                                                $sql2 = "UPDATE `referral_counseling` 
                                                        ...
                                                        ?>
                                                            ...
                                                            if ($_POST['status'] == "Reject") {
                                                                ...
                                                                $mail->addAddress($mailTo, "GuidanceOffice");
                                                                $mail->isHTML(true);
                                                                $mail->Subject = "Referral Request Rejected";
                                                                $mail->Body = $body;
                                                                $mail->AltBody = "text version";
                                                            ...
                                                            <form action="" method="post">
                                                                ...
                                                                if ($row['status'] != "Done" && $row['catered_by'] != null && $row['catered_by'] != 'notset') { ?>
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <input type="hidden" name="name" required id="" value="<?php if ($row['name'] != null) {
                                                                                                                                        echo $row['name'];
                                                                                                                                    } ?>" />
                                                                            <input type="hidden" required name="email" id="" value="<?php if ($row['name'] != null) {
                                                                                                                                        echo $row['email'];
                                                                                                                                    } ?>" />
                                                                            <input type="hidden" required name="date" id="" value="<?php if ($row['name'] != null) {
                                                                                                                                        echo $row['date_prefer'];
                                                                                                                                    } ?>" />
                                                                            <input type="hidden" required name="time" id="" value="<?php if ($row['name'] != null) {
                                                                                                                                        echo $row['preferred_time'];
                                                                                                                                    } ?>" />
                                                                            <input type="hidden" required name="catered" id="" value="<?php if ($row['name'] != null) {
                                                                                                                                            echo $row['catered_by'];
                                                                                                                                        } ?>" />
                                                                        </li>
                                                                    </ul>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if (isset($_POST['saveoutcome'])) {
                                                            ...
                                                            $sql = "UPDATE `referral_counseling` SET `outcome`='$outcome' WHERE id = '$id'";
                                                            $con->query($sql) or die($con->error);
                                                        ?>
                                                            <meta http-equiv="refresh" content="1">
                                                            <p>
