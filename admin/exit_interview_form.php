...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $sql = "SELECT * FROM exit_interview WHERE college='$collegefilter' ORDER BY id DESC LIMIT $start, $limit";
                                    ...
                                    <div class="container" style="padding-bottom: 8px; background-color:aquamarine">
                                        <form action="" method="post" id="form" name="form">
                                            <ul class="pagination pagination" style="margin-left: 20% ;">
                                                <a href="exit_interview_form.php?page=<?php echo $previous; ?>" style="padding:8px;">
                                                    &laquo; Previous
                                                </a>
                                                <?php for ($i = 1; $i <= $pages; $i++) { ?>
                                                    <li style="padding:8px; ">
                                                        <a href="exit_interview_form.php?page=<?php echo $i; ?>">
                                                            <?php echo $i; ?>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                                <a href="exit_interview_form.php?page=<?php echo $next; ?>" style="padding:8px;">
                                                    Next &raquo;
                                                </a>
                                            </ul>
