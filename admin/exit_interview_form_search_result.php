...
if (isset($_SESSION['UserLogin']) && $_SESSION['Access'] == "Administrator" || $_SESSION['Access'] == "Counselor") {
    ...
    $sql2 = "SELECT * FROM exit_interview WHERE name LIKE '%$search1%' AND college='$collegefilter' ORDER BY id DESC";
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="table-responsive">
                                    ...
                                    <form action="exit_interview_form_search_result.php" method="get">
                                        ...
                                        <?php do { ?>
                                            <?php if ($row2 != null) { ?>
                                                <tbody style=" white-space: nowrap; ">
                                                    <tr>
                                                        <td><a href="details_exit_interview.php?ID=<?php echo $row2['id']; ?>">Details</a></td>
                                                        <td style="color: red;"><?php echo $row2['id']; ?></td>
                                                        <td><?php echo $row2['name']; ?></td>
                                                        <td style="color: blue;"><?php echo $row2['email']; ?></td>
                                                        <td><?php echo $row2['added_at']; ?></td>
                                                    </tr>
                                                <?php } else {
