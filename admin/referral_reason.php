...
$sql = "SELECT * FROM referral_reason_list ORDER BY name ASC";
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="table-responsive">
                                <form action="add_reason_for_referral.php" method="post">
                                    ...
                                    <?php do { ?>
                                        <?php if ($row != null) { ?>
                                            <tbody style=" white-space: nowrap; ">
                                                <tr>
                                                    <td>
                                                        <a href="details_reason_for_referral.php?ID=<?php echo $row['id']; ?>">
                                                            Details
                                                        </a>
                                                    </td>
                                        ...
                                        <?php } else {
                                            echo '<h4 style="color: red;" >' . '<b>' . 'Reason for Referral' . '<b>' . ' (No Data!)' . '</h4>';
                                        } ?>
