                                ...
                                <table id="example" class="table table-hover">
                                    ...
                                    <div class="form-floating mb-3" style="padding: 8px; background-color: skyblue;">
                                        <form action="add_testing_date.php" method="post">
                                            ...
                                            <button role="button" name="addtesting" class="btn btn-primary btn-block">
                                                Add Date & Time
                                            </button>
                                    ...
                                    <tbody style=" white-space: nowrap;">
                                                ...
                                                <?php if ($row9 != null) { ?>
                                                    <td>
                                                        <form action="" method="post">
                                                            <button class="fa fa-trash" style="color: red; border-color: white;" type="submit" name="deletetestingdate">
                                                                Delete
                                                            </button>
                                                            <input type="hidden" name="ID" value="<?php echo $row9['id']; ?>">
                                                            <input type="hidden" name="date" value="<?php echo $row9['testing_date']; ?>">
                                                        </form>
                                                    </td>
                                                    <td><?php echo $row9['testing_date']; ?></td>
                                                <?php } else { ?>
                                                    <td>
                                                        <p>
                                        ...
                                        <?php } while ($row9 = $datetesting->fetch_assoc()) ?>
                                    </tbody>

                                    <thead style=" white-space: nowrap; background-color: skyblue; ">
                                        <tr>
                                            <th>
                                                <form action="add_testing_time.php" method="post">
                                                    <button role="button" name="addtesting" class="btn btn-primary btn-block">
                                                        Add Time
                                                    </button>
                                                </form>
                                    ...
                                    <tbody style=" white-space: nowrap;">
                                        <?php do { ?>
                                            <tr>
                                                <?php if ($row10 != null) { ?>
                                                    <td>
                                                        <form action="" method="post">
                                                            <button class="fa fa-trash" style="color: red; border-color: white;" type="submit" name="deletetestingtime">
                                                                Delete
                                                            </button>
                                                            <input type="hidden" name="ID" value="<?php echo $row10['id']; ?>">
                                                            <input type="hidden" name="time" value="<?php echo $row10['testing_time']; ?>">
                                                        </form>
                                                    </td>
                                                    <td><?php echo $row10['testing_time']; ?></td>
                                                <?php } else { ?>
                                                    <td>
                                                        <p>
                                        ...
                                        <?php } while ($row10 = $timetesting->fetch_assoc()) ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
