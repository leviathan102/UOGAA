                        ...
                        <div class="details personal">
                            ...
                            <div class="fields">
                                ...
                                <div class="input-field">
                                    ...
                                    <select style="width: 100%;" required name="if_student" id="mySelect" onchange="changeDropdown(this.value);" aria-label="Floating label select example" required>
                                        <option></option>
                                        <?php if ($_POST["college_of"] != 'Not a Student') { ?>
                                ...
                                <div id="name" class="fields">
                                    <div class="input-field">
                                        <?php if ($_POST["college_of"] != 'Not a Student') { ?>
                                            <label for="">College/Program</label>
