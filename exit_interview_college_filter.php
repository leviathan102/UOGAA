...
// for college list
$sql = "SELECT * FROM college_list WHERE name!='Non-Teaching Employee Association' && name!='Doctoral Programs' && name!='Masters Degree Programs' && name!='NSTP Unit' ORDER BY name ASC";
                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            ?>
                                <form action="add_exit_interview.php" method="post">
                                    <div class="form-floating mb-3">
                                        ...
                                        <button type="submit" name="add_exit_interview" class="btn btn-success btn-block"> Next</button><br>
