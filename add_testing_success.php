...
<body id="formcounseling">
    ...
    <div class="container">
        ...
        if (isset($_POST['emailtesting'])) {
            $fname = $_POST['name'].'('.$_POST['if_student'].')';
            $email = $_POST['email'];
            $fage = $_POST['age'];
            ...
            $outcome = 'notset';
            $sql = "INSERT INTO `testing_service`(`name`, `email`, `age`, `college_of`, `course`, `year_level`, `gender`, `purpose`, `option_for_newly_hired`, `date_prefer`, `time_prefer`, `room`, `catered_by`, `status`, `outcome`) VALUES ('$fname','$email','$fage','$fcollege','$fcourse','$fyearlevel','$fgender','$fpurpose','$fnewlyhired','$testdate','$testtime','$testroom','$cater','$fstatus','$outcome')";
            ...
            $testgoal = 'notset';
            $testaddress = 'notset';
            $sql16 = "INSERT INTO `students_table`(`name`, `email`, `college`, `yearlevel`, `course`, `age`, `gender`, `preferredmode`, `phonenumber`, `facebook`, `preferredtime`, `servicerequested`, `referreddate`, `referrer`, `reason`, `otherreason`, `bestpart`, `worstpart`, `likebest`, `likeleast`, `immediateplan`, `longtermgoal`, `homeaddress`, `purpose`, `newlyhired`) VALUES ('$fname','$email','$fcollege','$fyearlevel','$fcourse','$testage','$fgender','$testmode','$testphone','$testfacebook','$testtime','$servicereq','$testdate','$testreferrer','$testreason','$testotherreason','$testbest','$testworst','$testlike','$testleast','$testplan','$testgoal','$testaddress','$fpurpose', '$fnewlyhired')";
